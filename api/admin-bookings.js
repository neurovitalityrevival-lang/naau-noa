...
function supabase(path) {
  ...
  return new Promise((resolve, reject) => {
    const req = https.request({
      ...
      method: 'GET',
      headers: { 'apikey': 'sb_publishable_eyMShPrkyDZvtSejJDx9HA_UgMsRwJI', 'Authorization': `Bearer sb_publishable_eyMShPrkyDZvtSejJDx9HA_UgMsRwJI`, 'Content-Type': 'application/json' }
    }, (res) => {
      let d = '';
      res.on('data', c => d += c);
